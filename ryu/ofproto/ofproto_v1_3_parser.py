...
class OFPMeterBandDrop(OFPMeterBandHeader):
    def __init__(self, type_, len_, rate, burst_size):
        super(OFPMeterBandDrop, self).__init__(ofproto_v1_3.OFPMBT_DROP, ofproto_v1_3.OFP_METER_BAND_DROP_SIZE,
                                               rate, burst_size)
...
class OFPMeterBandDscpRemark(OFPMeterBandHeader):
    def __init__(self, type_, len_, rate, burst_size, prec_level):
        ...
        super(OFPMeterBandDscpRemark, self).__init__(ofproto_v1_3.OFPMBT_DSCP_REMARK, ofproto_v1_3.OFP_METER_BAND_DSCP_REMARK_SIZE,
                                                     rate, burst_size)

    def _serialize_stats_body(self, buf, offset):
        msg_pack_into(ofproto_v1_3.OFP_METER_BAND_DSCP_REMARK_PACK_STR, buf, offset,
                      self.type, self.len, self.rate, self.burst_size, self.prec_level)


class OFPMeterBandExperimenter(OFPMeterBandHeader):
    def __init__(self, type_, len_, rate, burst_size, experimenter):
        self.experimenter = experimenter
        super(OFPMeterBandExperimenter, self).__init__(ofproto_v1_3.OFPMBT_EXPERIMENTER, ofproto_v1_3.OFP_METER_BAND_EXPERIMENTER_SIZE,
                                                       rate, burst_size)

    def _serialize_stats_body(self, buf, offset):
        msg_pack_into(ofproto_v1_3.OFP_METER_BAND_EXPERIMENTER_PACK_STR, buf, offset,
                      self.type, self.len, self.rate, self.burst_size, self.experimenter)
